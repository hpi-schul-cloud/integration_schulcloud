...
namespace OCA\Schulcloud\Dashboard;
...
class SchulcloudWidget implements IWidget {
	...
	public function getId(): string {
		return 'schulcloud_notifications';
	}
	...
	public function getTitle(): string {
        return $this->l10n->t('Schulcloud notifications');
        }
